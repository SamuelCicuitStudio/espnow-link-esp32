...
<div class="card">
  ...
  <div class="row">
    ...
    <label class="small">setting key <input id="settingKey" placeholder="example: fan_mode"></label>
    <label class="small">setting value <input id="settingVal" placeholder="example: 1"></label>
