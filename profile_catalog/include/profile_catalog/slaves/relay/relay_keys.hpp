...
#define PCAT_RELAY_KEY_CLIBD "cbaud"  // Local CLI/USB serial baud (applied at boot).
...
#define PCAT_RELAY_SET_CLIBD "cli_baud"
...
#define PCAT_RELAY_SET_CLIBD_DEF 115200U
#define PCAT_RELAY_SET_CLIBD_MIN 9600U
#define PCAT_RELAY_SET_CLIBD_MAX 921600U
...
#define PCAT_RELAY_SETMAP "device_name,channel,split_idx,pulse_ms,hold_ms,interlock,rt_limit_c,sensor_a_mac,sensor_b_mac,relay1_enable,relay2_enable,persist_output_state,LoopAuto,fan_mode,buzzer_enable,cli_baud,led_feedback_enable,rgb_idle_color,rgb_alert_color,rgb_brightness,push_enabled,push_mode,push_interval_ms,push_delta_abs,push_min_gap_ms,push_metric_scope,topo_version,topo_seed_id,topo_state,topo_prev_mac,topo_next_mac,topo_allowed_sources_blob"
...
PCAT_ASSERT_NVS_KEY_LEN(PCAT_RELAY_KEY_CLIBD);
